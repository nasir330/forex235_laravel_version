...
<body>
    ...
    <div class="container-fluid">
        <div class="row text-right">
            <div class="col-md-12 premiumAccount align-self-right">
                <h1 class="ml-auto">Premium Account</h1>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-lg-6 accountFeatures">
                <h1>Premium </h1>
                <p>
                    Open a Premium account today to enjoy swap-free trading with no minimum deposit and commission-free
                    transactions. Access the financial markets seamlessly using popular trading platforms like MT4, MT5,
                    Webtrader. Experience the benefits of a Premium account designed for retail traders
                    seeking a flexible and cost-effective trading environment.
                </p>
            </div>
            <div class="col-12 col-lg-6">
                <img class="img-fluid" src="Assets/images/premium-account.webp" alt="Premium Trading Account">
            </div>
        </div>
    </div>
    <div class="container-fluid">
            ...
            <div class="col-md-12 paymentFeesSection">
                <div class="row">
                    <div class="col-md-12 text-center bg-dark text-light m-1">
                        <h1 class="text-uppercase">Premium Account Features</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">

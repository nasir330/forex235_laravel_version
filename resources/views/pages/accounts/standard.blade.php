    ...
    <div class="container-fluid">
        <div class="row text-right">
            <div class="col-md-12 standardAccount align-self-right">
                <h1 class="ml-auto">Standard Account</h1>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-lg-6 accountFeatures">
                <h1>Standard </h1>
                <p>
                    Open a Standard Account today and elevate your trading experience with competitive spreads, advanced
                    trading platforms, and exclusive benefits tailored to meet your trading needs. Access the financial
                    markets with ease and take advantage of the features designed to enhance your trading journey.
                </p>                
            </div>
            <div class="col-12 col-lg-6">
                <img class="img-fluid" src="Assets/images/standard-account.webp" alt="Standard Trading Account">
            </div>
        </div>
    </div>
    <div class="container-fluid">
            ...
            <div class="col-md-12 paymentFeesSection">
                <div class="row">
                    <div class="col-md-12 text-center bg-dark text-light m-1">
                        <h1 class="text-uppercase">Standard Account Features</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">

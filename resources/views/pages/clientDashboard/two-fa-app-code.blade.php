                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <div>
                                    ...
                                    <h3> <i class="fa-duotone fa-layer-group"></i></h3>
                                    <p>Enter the 6 digit code from your 2FA App</p>
                                </div>
                            </div>
                            <div class="col-md-7 mt-3">
                                ...
                                <form action="">
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <img class="img-fluid" src="Assets/images/clientDashboard/2fa-app-code.webp" alt="two factor auth">
                                        </div>
